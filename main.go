...
func main() {
	...
	svc := &httpHandler{cfg: cfg, wholesalersv: &wholesaler_service{d: db}, usersv: &user_service{d: db}, wxpluginprogramsv: &wxplugin_program_service{d: db}}
	...
	zap.L().Info("sale user service stopped")
}
